...
export function ClearanceStagePage() {
   ...
   */
  /*
   * The business as every office sheet carries it — derived once, in
   * carriedOver.ts, because the filing's own page renders these same sheets
   * read-only now (checklist item 24) and two copies of that mapping is two
   * answers the day one is corrected.
   */
  const carriedOver = carriedOverBusiness(application)
